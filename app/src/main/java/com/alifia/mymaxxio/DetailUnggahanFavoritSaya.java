...
public class DetailUnggahanFavoritSaya extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_detail_unggahan_favorit_saya);
    ...
    // masih copas an dari DetailUnggahanSaya
